...
const GbEducationNews = () => {
  const [articles, setArticles] = useState([]);
  const [selectedArticle, setSelectedArticle] = useState(null);
  const [error, setError] = useState(null);

  const API_KEY = "a352400afadf362f7009ecab7e0941d3";
  const API_URL = `https://gnews.io/api/v4/search?q=gilgit%20baltistan%20education&lang=en&country=pk&apikey=${API_KEY}`
//   `https://gnews.io/api/v4/top-headlines?country=pk&category=general&apikey=${API_KEY}`;
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-blue-600 mb-6">GB Education</h1>
...
export default GbEducationNews;
