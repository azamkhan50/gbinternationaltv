...
const SkarduNews = () => {
  ...
  const SEARCH_QUERY = "Skardu News"; // or use channelId=YOUR_CHANNEL_ID
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <h1 className="text-3xl font-bold text-blue-600 mb-6">Skardu News</h1>
